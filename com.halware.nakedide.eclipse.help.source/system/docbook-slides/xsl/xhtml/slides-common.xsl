...
<xsl:template name="top-nav">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" class="navhead">
...
<xsl:template name="bottom-nav">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" class="navfoot">
...
<xsl:template name="links">
  ...
  <xsl:if test="$tocfile != ''">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="contents" href="{$tocfile}">
  ...
  <xsl:if test="$home">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="top">
      <xsl:attribute name="href">
        <xsl:apply-templates select="$home" mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
    ...
    <link xmlns="http://www.w3.org/1999/xhtml" rel="first">
      <xsl:attribute name="href">
        <xsl:apply-templates select="$home" mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
  ...
  <xsl:if test="$up">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="up">
      <xsl:attribute name="href">
        <xsl:apply-templates select="$up" mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
  ...
  <xsl:if test="$prev">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="previous">
      <xsl:attribute name="href">
        <xsl:apply-templates select="$prev" mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
  ...
  <xsl:if test="$next">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="next">
      <xsl:attribute name="href">
        <xsl:apply-templates select="$next" mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
    ...
    <xsl:if test="$last">
      <link xmlns="http://www.w3.org/1999/xhtml" rel="last">
        <xsl:attribute name="href">
  ...
  <xsl:for-each select="foil">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="slides">
      <xsl:attribute name="href">
  ...
  <xsl:for-each select="foilgroup|../foilgroup">
    <link xmlns="http://www.w3.org/1999/xhtml" rel="section">
      <xsl:attribute name="href">
        <xsl:apply-templates select="." mode="filename"/>
      </xsl:attribute>
      <xsl:attribute name="title">
...
<xsl:template match="slidesinfo/title">
  <h1 xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}"><xsl:apply-templates/></h1>
</xsl:template>
...
<xsl:template match="slidesinfo/author|slidesinfo/authorgroup/author">
  <h1 xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}"><xsl:apply-imports/></h1>
</xsl:template>

<xsl:template match="slidesinfo/releaseinfo">
  <h4 xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}"><xsl:apply-templates/></h4>
</xsl:template>
...
<xsl:template name="toc-body">
  ...
  <p xmlns="http://www.w3.org/1999/xhtml" class="toctitle">
    <b>
  ...
  <dl xmlns="http://www.w3.org/1999/xhtml" class="toc">
...
<xsl:template match="processing-instruction('dbhtml')" mode="css.pi">
  ...
  <xsl:choose>
    ...
    <xsl:when test="contains($href, '//')">
      <link xmlns="http://www.w3.org/1999/xhtml" type="text/css" rel="stylesheet" href="{$href}"/>
    </xsl:when>
...
<xsl:template match="figure">
  ...
  <xsl:if test="following-sibling::*"><hr xmlns="http://www.w3.org/1999/xhtml"/></xsl:if>
</xsl:template>
...
<xsl:template match="subtitle">
  <h2 xmlns="http://www.w3.org/1999/xhtml" class="subtitle">
    <xsl:apply-templates/>
  </h2>
</xsl:template>
