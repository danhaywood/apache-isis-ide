...
public class MustSatisfyMetadataDescriptor extends StringSpecificMetadataDescriptor {

	public MustSatisfyMetadataDescriptor() {
		super(
            "MustSatisfy", 
			new SingleValueAnnotationEvaluatorAndModifier(
                    "org.apache.isis.applib.annotation.MustSatisfy",
