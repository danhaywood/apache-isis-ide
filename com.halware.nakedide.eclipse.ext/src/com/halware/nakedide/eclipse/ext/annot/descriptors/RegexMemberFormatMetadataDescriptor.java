...
/**
 * Maintains <tt>@Regex#format</tt> annotation member.
 */
public class RegexMemberFormatMetadataDescriptor extends StringSpecificMetadataDescriptor {

	public RegexMemberFormatMetadataDescriptor() {
        super(
                "RE#format", 
