...
public class NakedObjectStringPropertiesView
	extends AbstractNodeView {  
	
    public static final String ID = NakedObjectStringPropertiesView.class.getCanonicalName();
    
	private final static Logger LOGGER = Logger.getLogger(NakedObjectStringPropertiesView.class);
	public Logger getLOGGER() {
		return LOGGER;
	}

	public NakedObjectStringPropertiesView() {
		super(XP_STRING_PROPERTIES_METADATA_DESCRIPTORS_PROVIDER);
	}
	
	private static final String XP_STRING_PROPERTIES_METADATA_DESCRIPTORS_PROVIDER = 
		Activator.getPluginId() + ".stringPropertiesMetadataDescriptorsProviders";
	...
	public <T extends ICellModifier> T getCellModifier(MetadataDescriptorSet set) {
		if (cellModifier == null) {
			cellModifier = new NakedObjectStringPropertiesCellModifier(set);
		}
	...
	public <T extends IBaseLabelProvider> T getLabelProvider(MetadataDescriptorSet set) {
		if (labelProvider == null) {
			labelProvider = new NakedObjectStringPropertiesLabelProvider(set); 
		}
