...
public class TitleAbbreviatedToMetadataDescriptor extends MetadataDescriptor {

	public TitleAbbreviatedToMetadataDescriptor() {
		super(
            "Title#abbreviatedTo", 
            new MultipleValueAnnotationSingleMemberEvaluatorAndModifier(
                "org.apache.isis.applib.annotation.Title", 
                "abbreviatedTo",
