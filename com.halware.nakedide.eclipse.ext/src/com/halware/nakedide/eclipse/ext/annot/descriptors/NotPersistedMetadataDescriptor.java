...
public class NotPersistedMetadataDescriptor extends MetadataDescriptor {

	public NotPersistedMetadataDescriptor() {
		super(
                "NotPersisted",  
				new MarkerAnnotationEvaluatorAndModifier(
                        "org.apache.isis.applib.annotation.NotPersisted")
		);
	}
