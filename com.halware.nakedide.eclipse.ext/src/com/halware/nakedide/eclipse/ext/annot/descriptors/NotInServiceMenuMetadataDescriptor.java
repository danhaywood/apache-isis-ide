...
public class NotInServiceMenuMetadataDescriptor extends MetadataDescriptor {

	public NotInServiceMenuMetadataDescriptor() {
		super(
			"NotContributed",  
			new MarkerAnnotationEvaluatorAndModifier(
                "org.apache.isis.applib.annotation.NotContributed")		);
	}
