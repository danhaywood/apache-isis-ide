...
public final class NakedObjectActionParametersCellModifier extends AbstractNodeCellModifier<NakedObjectActionParameter> {
	
	private final static Logger LOGGER = Logger.getLogger(NakedObjectActionParametersCellModifier.class);
	public Logger getLOGGER() {
		return LOGGER;
	}
	
	public NakedObjectActionParametersCellModifier(MetadataDescriptorSet metadataDescriptorSet) {
	...
	protected void doModify(NakedObjectActionParameter nakedObjectActionParameter, String property, Object value) {
		getPropertyDescriptorSet().getOwner().refresh(
			new StructuredSelection(
				new Object[]{
					nakedObjectActionParameter.getNakedObjectAction(),
